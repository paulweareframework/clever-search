...
namespace Weareframework\CleverSearch\Library\Files;
...
class StoredSearchFile
{
    ...
    public function __construct(Config $config, Manager $manager, Yaml $yaml, Sites $sites) {
        ...
        $this->yaml = $yaml;
        $this->configFile = $config->get('statamic.clever-search.file');
    ...
    private function file() {
        return base_path("content/clever-search/{$this->configFile}_{$this->locale}.yaml");
    }
    ...
    private function cacheKey() {
        return "cleve_search_stored_search_{$this->locale}";
    }
}
